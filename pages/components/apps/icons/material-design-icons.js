...
const MaterialDesignIcons = () => {
  return (
    <>
        <Seo title="Material Design Icons"/>

    <PageHeader title="MaterialDesignIcons" item="Icons" active_item="MaterialDesignIcons"/>
          ...
          <Card.Body>
            <Row className="row-sm">
              <Col lg={12} sm={12} mb={4}>
                <h3 className="main-content-label">MaterialDesignIcons</h3>
                <p className="mb-2">
                  Simply beautiful open source icons. For more info
                  <a href="https://materialdesignicons.com"> click here
                  </a>
                  .
                </p>
                <p>
