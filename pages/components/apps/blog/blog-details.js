						...
						<Card.Body>
								...
								<div className="example">
									<div className="d-sm-flex comment-section">
										<div className="d-flex me-3">
											<Link href="#!">
													<span className="main-avatar avatar"><img className='avatar' alt="img" src={user1.src} /></span>
												</Link>
										</div>
							...
							<div className="text-wrap mt-2">
								<div className="example">
									<div className="d-sm-flex comment-section">
										<div className="d-flex me-3">
											<Link href="#!"><span className="main-avatar avatar"><img className="main-avatar avatar" alt="img" src={user2.src} /></span></Link>
										</div>
										<div className="media-body">
							...
							<div className="text-wrap mt-2">
								<div className="example">
									<div className="d-sm-flex comment-section">
										<div className="d-flex me-3">
											<Link href="#!">
												<span className="main-avatar avatar"><img className="main-avatar avatar" alt="img" src={user3.src} /></span> 
												</Link> </div>
										<div className="media-body">
