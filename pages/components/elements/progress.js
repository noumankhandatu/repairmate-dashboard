          ...
          <Card className=" custom-card" id="sizes">
            ...
            <Card.Body>
              <div className="text-wrap">
                ...
                <div className="text-wrap">
                  <div className="example">
                    <ProgressBar now={45} className="mg-b-10 progress-bar-xs" />
                    <ProgressBar now={55} className=" mg-b-10 progress-bar-xs" variant="secondary" />
                    <ProgressBar now={65} className=" mg-b-10 progress-bar-xs" variant="info" />
                  </div>
                </div>
                <span className="tx-uppercase tx-11 d-block mg-t-20 mg-b-5">
                  Size Small
                ...
                <div className="text-wrap">
                  <div className="example">
                    <ProgressBar now={25} className="mg-b-10 progress-bar-sm" variant="default" />
                    <ProgressBar now={35} className="mg-b-10 progress-bar-sm" variant="secondary" />
                    <ProgressBar now={45} className="mg-b-10 progress-bar-sm" variant="info" />
                  </div>
                </div>
                <span className="tx-uppercase tx-11 d-block mg-t-20 mg-b-5">
                  Size Normal
                ...
                <div className="text-wrap">
                  <div className="example">
                    <ProgressBar now={25} className="mg-b-10 progress-bar-lg" variant="default" />
                    <ProgressBar now={35} className="mg-b-10 progress-bar-lg" variant="secondary" />
                    <ProgressBar now={45} className="mg-b-10 progress-bar-lg" variant="info" />
                  </div>
