            ...
            <Card.Header className="d-flex justify-content-between align-items-center">
              <div>
                ...
                <p className="text-muted card-sub-title">
                  The basic dropdown menu example when toggle.
                </p>
              </div>
              <Form.Check
              ...
              <div className="text-wrap">
                <div className="example">
                  <Row className=" row-xs">
                    <Col sm={6} md={3}>
                      <DropdownButton drop="end" variant="info" title="Dropdown Menu" className='new-me-3'>
                        <Dropdown.Item href="#!">Action</Dropdown.Item>
                        <Dropdown.Item href="#!">Another action</Dropdown.Item>
                        <Dropdown.Item href="#!">
                          Something else here
                    ...
                    <Col sm={6} md={3} className="mg-t-10 mg-sm-t-0">
                      <DropdownButton drop="end" variant="danger" title="dropdown Menu" className='new-me-3'>
                        <Dropdown.Item href="#!">Action</Dropdown.Item>
                        <Dropdown.Item href="#!">Another action</Dropdown.Item>
                        <Dropdown.Item href="#!">
                          Something else here
