...
import { Breadcrumb, Button, Row, Col, Card, Container } from "react-bootstrap";
import Link from "next/link"
import Seo from '../../../shared/layout-components/seo/seo';


//Images
import team from "../../../public/assets/img/media/team.jpg"
          ...
          <Row className="row-sm">
            <Col xl={6} lg={6} md={12} sm={12}>
              <div className="mt-5">
                ...
                <Link href="#!" className="btn ripple btn-primary btn-sm" role="button">
					        Contact Us
                </Link>
              </div>
            </Col>
            <Col xl={6} lg={6} md={12} sm={12}>
              <div className="text-xl-end text-center">
                <img src={team.src} alt="img" className="rounded-5" />
              </div>
            </Col>
          </Row>
        </Col>
            ...
            <Card.Body>
              <div className="counter-status">
                <div className="text-center mb-1">
                  <svg
                    className="statistics-icon bg-secondary-light"
                    xmlns="http://www.w3.org/2000/svg"
                    enableBackground="new 0 0 24 24"
                    viewBox="0 0 24 24"
                  >
          ...
          <Card className="custom-card bg-primary-transparent">
            <Card.Body>
              <div className="counter-status">
                <div className="text-center mb-1">
                  <svg
                    className="statistics-icon bg-warning-light"
                    xmlns="http://www.w3.org/2000/svg"
                    enableBackground="new 0 0 24 24"
                    viewBox="0 0 24 24"
                  >
          ...
          <Card className="custom-card bg-primary-transparent">
            <Card.Body>
              <div className="counter-status">
                <div className="text-center mb-1">
                  <svg
                    className="statistics-icon bg-danger-light"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                  >
                    <path
          ...
          <Card className="custom-card bg-primary-transparent">
            <Card.Body>
              <div className="counter-status">
                <div className="text-center mb-1">
                  <svg
                    className="statistics-icon bg-info-light"
                    xmlns="http://www.w3.org/2000/svg"
                    enableBackground="new 0 0 24 24"
                    viewBox="0 0 24 24"
                  >
      ...
      <Row className="row-sm">
        ...
        <Col xl={3} lg={6} md={6} sm={6}>
          <Card className="custom-card our-team">
            <Card.Body>
              ...
              <div className="text-center mt-3">
                <Link href="#!" target="_blank" className="btn btn-sm ripple bg-primary-transparent text-primary rounded-circle me-1" >
					<i className="mdi mdi-facebook"></i>
                </Link>
                <Link href="#!" target="_blank" className="btn btn-sm ripple bg-danger-transparent text-danger rounded-circle me-1" >
                  <i className="mdi mdi-google"></i>
                </Link>
                <Link href="#!" target="_blank" className="btn btn-sm ripple bg-info-transparent text-info rounded-circle" >
        ...
        <Col xl={3} lg={6} md={6} sm={6}>
          <Card className="custom-card our-team">
            <Card.Body>
              <div className="picture avatar-lg online text-center">
                <img alt="avatar" className="rounded-circle" src={users6.src} />
              </div>
              <div className="text-center mt-3">
                <Link href="#!">
                  <h5 className="pro-user-username text-dark mt-2 mb-0">Benedict Vallone</h5>
                </Link>
        ...
        <Col xl={3} lg={6} md={6} sm={6}>
          <Card className="custom-card our-team">
            <Card.Body>
              <div className="picture avatar-lg online text-center">
                <img alt="avatar" className="rounded-circle" src={users7.src} />
              </div>
              <div className="text-center mt-3">
                <Link href="#!">
                  <h5 className="pro-user-username text-dark mt-2 mb-0">
              ...
              <div className="text-center mt-3">
                ...
                <Link
                  href="#!"
                  target="_blank"
                  className="btn btn-sm ripple bg-danger-transparent text-danger rounded-circle me-1"
                >
                  <i className="mdi mdi-google"></i>
                </Link>
                <Link
            ...
            <Card.Body>
              ...
              <div className="text-center mt-3">
                <Link
                  href="#!"
                  target="_blank"
                  className="btn btn-sm ripple bg-primary-transparent text-primary rounded-circle me-1"
                >
                  <i className="mdi mdi-facebook"></i>
                </Link>
                <Link
