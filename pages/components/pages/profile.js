...
const Gallery2 = dynamic(()=>import('../../../shared/data/pages/gallery'), { ssr: false })
...
import users11 from "../../../public/assets/img/users/11.jpg"
                          ...
                          <div className="col-12">
                            <Card className=" mg-b-20 border">
                              ...
                              <Card.Body>
                                ...
                                <Row className=" row-sm">
                                  <div className="col">
                                    <img alt="img" className="wd-200 m-2" src={media3.src} />
                                    <img alt="img" className="wd-200 m-2" src={media11.src} />
                                  </div>
                                </Row>
                            ...
                            <Card className=" mg-b-20 border">
                              <Card.Header className="p-4">
                                <div className="media">
                                  <div className="media-user me-2">
                                    <div className="main-img-user avatar-md">
                                      <img alt="user6" className="rounded-circle" src={users6.src} />
                                    </div>
                                  </div>
                                  <div className="media-body">
                                    <h6 className="mb-0 mg-t-2 ms-2">
                              ...
                              <Card.Body>
                                ...
                                <Row className=" row-sm">
                                  <div className="col">
                                    <img alt="img" className="wd-200 m-2" src={media2.src} />
                                    <img alt="img" className="wd-200 m-2" src={media12.src} />
                                  </div>
                                </Row>
                                <div className="media mg-t-15 profile-footer">
                                  <div className="media-user me-2">
                            ...
                            <Card className="border">
                              <Card.Header className="p-4">
                                <div className="media">
                                  <div className="media-user me-2">
                                    <div className="main-img-user avatar-md"><img alt="user2" className="rounded-circle" src={users2.src} /></div>
                                  </div>
                                  <div className="media-body">
                              ...
                              <Card.Body className="h-100">
                                ...
                                <Row className="row row-sm">
                                  <div className="col">
                                    <img alt="img" className="wd-200 m-2" src={media4.src} />
                                    <img alt="img" className="wd-200 m-2" src={media7.src} /> </div>
                                </Row>
                                <div className="media mg-t-15 profile-footer">
                                  <div className="media-user me-2">
                                    <div className="demo-avatar-group">
                                      <div className="demo-avatar-group main-avatar-list-stacked">
                                        <div className="main-img-user online"><img alt="user11" className="rounded-circle" src={users11.src} /></div>
                                        <div className="main-img-user"><img alt="user12" className="rounded-circle" src={users12.src} /></div>
                                        <div className="main-img-user"><img alt="user4" className="rounded-circle" src={users4.src} /></div>
                                        <div className="main-img-user online"><img alt="user5" className="rounded-circle" src={users5.src} /></div>
                      ...
                      <Card className="custom-card border">
                        <div className=" text-center">
                          <div className="user-lock text-center">
                            ...
                            <Link href="#!">
                              <img alt="avatar" className="rounded-circle" src={users2.src} />
                            </Link>
                          </div>
                          <Link href="#!">
                            <h5 className=" mb-1 mt-3 main-content-label">
                      ...
                      <Card className="custom-card border">
                        <div className=" text-center">
                          ...
                          <Dropdown className=" text-end">
                            ...
                            <Link href="#!">
                              <img src={users1.src} className="rounded-circle" alt="img" />
                            </Link>
                          </div>
                          <Link href="#!">
                            <h5 className="mb-1 mt-3  main-content-label">
