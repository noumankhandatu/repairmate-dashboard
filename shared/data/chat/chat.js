...
import { Tabs, OverlayTrigger, Tooltip, Tab, Button, Col, Row, Nav, Card, Form, InputGroup, Dropdown } from "react-bootstrap";
    ...
    <div>
      ...
      <Col sm={12} md={12} lg={12} xl={3}>
        <Card className="card custom-card chat-account overflow-hidden">
          <div className="d-block pt-0 main-content-app overflow-overlay">
